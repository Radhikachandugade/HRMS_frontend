...
import {
  listLeaveAdminRequests,
  updateLeaveRequest,
} from "../actions/approveAction";
...
const LeaveRequestListScreen = () => {
  ...
  const leaveRequestAdminList = useSelector(
    (state) => state.leaveRequestAdminList
  );
    ...
    <>
      ...
      {loading ? (
        ...
        <Box bgColor="white" rounded="lg" shadow="lg" px="5" py="5">
          {errorUpdate ? <Message type="error">{errorUpdate}</Message> : null}
